...
import Card from '../_components/organisms/Card/Card'
import Navbar from '../_components/organisms/Navbar/Navbar'
import ContactSticky from '../_components/atoms/ContactSticky/ContactSticky'
      ...
      imgsArr: [
        {
          ...
          alt: 'React.js',
          description: 'React is an open-source, front-end, JavaScript framework for building user interfaces. ',
        },
        {
        ...
        },
        {
          ...
          alt: 'github',
          description: 'Github is a developer platform to build, store, scale, and deliver secure software.',
        },
        {
      ...
      imgsArr: [
        {
          ...
          alt: 'Figma software',
          description: 'Figma is the vector-based collaborative design tool for building meaningful products.',
        },
        {
          id: 1,
        ...
        },
        {
          ...
          description: 'Adobe Illustrator is a vector-based software for design',
        },
        {
          id: 6,
          src: '/assets/imgs/photoshop.svg',
          alt: 'Photoshop software',
          description: 'Adobe Photoshop is a bitmap-based software for photo editing',
        },
        {
          id: 7,
