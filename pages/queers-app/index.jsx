      ...
      <div className={styles.container}>
        ...
        <section className={styles.innerSection} id={"brand"}>
          ...
          <div className={styles.textBoxes}>
            <p>
              ...
              entities close to and/or in support of the community{"'"} s
              rights; hence the name Queers, a highly used and strongly
              identifying term, with a direct reference and lively tone.
            </p>
            <p>
        ...
        <section className={styles.innerSection}>
          ...
          <p>
            ...
            outlined. In the target there are three main type of users: 1{")"}
            those who need the service or the support, they often prefer to stay
            anonymous and to not register; 2{")"} those who are more interested
            to the recreational part and to the life of the community; 3{")"}
            the associations who want to promote their activities toward the
            community.
          </p>
